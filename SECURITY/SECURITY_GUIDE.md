# IronDAG Security Guide

## 🔒 Security Overview

This guide covers security best practices for IronDAG users, validators, and developers.
...
```
Report to:
- security@irondag.io (for security vulnerabilities)
- dev@irondag.io (for general inquiries)
- Include details
- Proof of concept
- Impact assessment
```
