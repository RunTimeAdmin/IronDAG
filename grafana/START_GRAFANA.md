# Starting Grafana for IronDAG Monitoring
...
You should see:
- `IronDAG-prometheus` - Running
- `IronDAG-grafana` - Running
...
- **Prometheus:** http://localhost:9090
  ...
  - Verify `IronDAG-node` target is UP
...
1. **Explore Dashboards:**
   - IronDAG Blockchain Overview
   - IronDAG Mining Metrics
   - IronDAG Sharding Metrics
   - IronDAG Network Metrics
   - IronDAG Transaction Metrics
...
2. Verify IronDAG node is running and exposing metrics
