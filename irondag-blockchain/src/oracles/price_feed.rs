...
pub struct PriceFeed {
    pub feed_id: String,              // e.g., "BTC/USD", "ETH/IDAG"
...
impl PriceFeedManager {
    ...
    pub fn submit_price_update(&mut self, update: PriceUpdate) -> Result<(), String> {
        ...
        let _oracle = registry_read
            .get_oracle(&update.oracle_address)
    ...
    pub fn aggregate_feed(&mut self, feed_id: &str, current_time: u64) -> Result<(), String> {
        ...
        let registry_read = self.registry.blocking_read();
        let assigned_oracles = registry_read
            .get_feed_oracles(feed_id)
...
mod tests {
    ...
    fn test_price_feed_creation() {
        let registry = Arc::new(RwLock::new(
            crate::oracles::registry::OracleRegistry::default(),
        ));
    ...
    fn test_price_aggregation_median() {
        ...
        assert_eq!(
            manager.get_price("BTC/USD"),
            Some(51_000_000_000_000_000_000)
        );
    }
}
